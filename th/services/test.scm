...
(define (list-of-firehol-interfaces? lst)
...
(define (serialize-list-of-firehol-interfaces field-name value)
...
(define (serialize-firehol-configuration configuration)
  (mixed-text-file
    "test.conf"
    #~(string-append #$(serialize-configuration configuration firehol-configuration-fields)))
)

(define-configuration firehol-configuration
  (interfaces
  (list-of-firehol-interfaces '())
  "A list of firehol-interfaces") ;list of firehol-interface
)
